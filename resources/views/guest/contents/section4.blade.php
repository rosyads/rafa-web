    ...
    <div class="container">
        ...
        <div class="grid-filter-wrap">
            ...
            <ul class="grid-filter style-2 mx-auto" data-container="#portfolio">
                ...
                <li><a href="#" data-filter=".pf-icons">IT Healthcare</a></li>
                <li><a href="#" data-filter=".pf-illustrations">Laboratory Diagnostic</a></li>
                <li><a href="#" data-filter=".pf-uielements">Medical Equipment</a></li>
    ...
    <div id="portfolio" class="portfolio row grid-container g-0">
         ...
         <article class="portfolio-item col-12 col-sm-6 col-md-4 col-lg-3 {{-- pf-media --}} pf-icons"> 
            <div class="grid-inner">
                <div class="portfolio-image">
                    <a href="#">
                        <img src="/img/guest/specifics/portfolio/1.jpg" alt="Open Imagination">
                    </a>
                    <div class="bg-overlay">
                        <div class="bg-overlay-content dark flex-column" data-hover-animate="fadeIn">
                            ...
                            <div class="portfolio-desc pt-0 center" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350">
                                <h3><a href="portfolio-single.html">Zetta PACS</a></h3>
                ...
                <div class="portfolio-image">
                    ...
                    <div class="bg-overlay">
                        <div class="bg-overlay-content dark flex-column" data-hover-animate="fadeIn">
                            <!-- Decription: Start -->
                            <div class="portfolio-desc pt-0 center" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350">
                                <h3><a href="portfolio-single.html">Zetta Clinic</a></h3>
                                <span><a href="#">Media</a>, <a href="#">Icons</a></span>
                            </div>
                        </div>
                        <div class="bg-overlay-bg dark" data-hover-animate="fadeIn"></div>
        ...
        <article class="portfolio-item col-12 col-sm-6 col-md-4 col-lg-3 pf-illustrations">
            <div class="grid-inner">
                <div class="portfolio-image">
                    <a href="#">
                        <img src="/img/guest/specifics/portfolio/2.jpg" alt="Open Imagination">
                    </a>
                    <div class="bg-overlay">
                        <div class="bg-overlay-content dark flex-column" data-hover-animate="fadeIn">
                            <!-- Decription: Start -->
        ...
        <article class="portfolio-item col-12 col-sm-6 col-md-4 col-lg-3 pf-graphics pf-uielements">
            <div class="grid-inner">
                <div class="portfolio-image">
                    <a href="#">
                        <img src="/img/guest/specifics/portfolio/3.jpg" alt="Open Imagination">
                    </a>
                    <div class="bg-overlay">
                        <div class="bg-overlay-content dark flex-column" data-hover-animate="fadeIn">
                            <!-- Decription: Start -->
                    ...
                    <div class="fslider" data-arrows="false" data-speed="400" data-pause="4000">
                        <div class="flexslider">
                            <div class="slider-wrap">
                                <div class="slide"><a href="#"><img src="/img/guest/specifics/portfolio/4.jpg" alt="Open Imagination"></a></div>
                                <div class="slide"><a href="#"><img src="/img/guest/specifics/portfolio/4-2.jpg" alt="Open Imagination"></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="bg-overlay">
            ...
            <div class="grid-inner">
                <div class="portfolio-image">
                    <div class="fslider" data-arrows="false">
                        <div class="flexslider">
                            <div class="slider-wrap">
                                <div class="slide"><a href="#"><img src="/img/guest/specifics/portfolio/5.jpg" alt="Open Imagination"></a></div>
                                <div class="slide"><a href="#"><img src="/img/guest/specifics/portfolio/5-2.jpg" alt="Open Imagination"></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="bg-overlay">
        ...
        <article class="portfolio-item col-12 col-sm-6 col-md-4 col-lg-3 pf-uielements pf-icons">
            <div class="grid-inner">
                <div class="portfolio-image">
                    <a href="#">
                        <img src="/img/guest/specifics/portfolio/6.jpg" alt="Open Imagination">
                    </a>
                    <div class="bg-overlay">
                        <div class="bg-overlay-content dark flex-column" data-hover-animate="fadeIn">
                            <!-- Decription: Start -->
        ...
        <article class="portfolio-item col-12 col-sm-6 col-md-4 col-lg-3 pf-uielements pf-media">
            <div class="grid-inner">
                <div class="portfolio-image">
                    <a href="#">
                        <img src="/img/guest/specifics/portfolio/7.jpg" alt="Open Imagination">
                    </a>
                    <div class="bg-overlay">
                        <div class="bg-overlay-content dark flex-column" data-hover-animate="fadeIn">
                            <!-- Decription: Start -->
        ...
        {{-- <article class="portfolio-item col-12 col-sm-6 col-md-4 col-lg-3 pf-graphics">
            <div class="grid-inner">
                <div class="portfolio-image">
                    <a href="#">
                        <img src="/img/guest/specifics/portfolio/8.jpg" alt="Open Imagination">
                    </a>
                    <div class="bg-overlay">
                        <div class="bg-overlay-content dark flex-column" data-hover-animate="fadeIn">
                            <!-- Decription: Start -->
